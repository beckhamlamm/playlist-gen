...
const WildCard = () => {
    ...
    // Add useEffect to check environment variables when component mounts
    useEffect(() => {
        console.log('Environment Variables:', {
            NODE_ENV: process.env.NODE_ENV,
            OPENAI_KEY_EXISTS: !!process.env.REACT_APP_OPENAI_KEY,
            OPENAI_KEY_LENGTH: process.env.REACT_APP_OPENAI_KEY ? process.env.REACT_APP_OPENAI_KEY.length : 0,
            OPENAI_KEY_PREFIX: process.env.REACT_APP_OPENAI_KEY ? process.env.REACT_APP_OPENAI_KEY.substring(0, 3) : 'none'
        });
    }, []);
